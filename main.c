...
start:
  printf ("------WELCOME TO GROUP 11's CAR RENTAL SYSTEM------\n\n");
...
//Printing out user's Option using Switch case.
	  ...
	  if (book == 1)
	    {
	      ...
	      printf
		("You are to make payment of GHC %d.00 to the Cashier.\n",
		 TotalFee);
	...
	case 2:
	  ...
	  if (book == 1)
	    {
	      printf
		("Enter the Number of Days of Renting: ");
	      scanf ("%d", &NumberofDays);
	       system("cls");
	      PriceperDay = 300;
	      TotalFee = PriceperDay * NumberofDays;
